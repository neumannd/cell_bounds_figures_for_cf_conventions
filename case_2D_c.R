...
# write plot to file
# png('pics/case_2D_c.png', width = 500, height = 350)
pdf('pics/case_2D_c.pdf', width = 7, height = 5.2, paper='special')
...
points(ulon_cell[2], ulat_cell[2], pch = 18, cex = 2, col = col_cell_draw)

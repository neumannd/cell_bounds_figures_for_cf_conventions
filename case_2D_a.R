...
angles_grid = c(42.5, 51.5, 60.5, 69.5, 78.5)
pi = 3.14
...
# write plot to file
# png('pics/case_2D_a.png', width = 500, height = 350)
pdf('pics/case_2D_a.pdf', width = 7, height = 5.2, paper='special')
...
# add grid ----
# grid lines, solid
lines(ulon_grid_low, ulat_grid_low, col = col_grid_draw, lwd = 2)
lines(ulon_grid_high, ulat_grid_high, col = col_grid_draw, lwd = 2)
lines(ulon_grid_higher, ulat_grid_higher, col = col_grid_draw, lwd = 2)
lines(rlon_grid, rlat_grid, col = col_grid_draw, lwd = 2)
...
points(ulon_grid_low, ulat_grid_low, pch = 18, cex = 2, col = col_grid_draw)
points(ulon_grid_high, ulat_grid_high, pch = 18, cex = 2, col = col_grid_draw)
points(ulon_grid_higher, ulat_grid_higher, pch = 18, cex = 2, col = col_grid_draw)
...
points(ulon_cell, ulat_cell, pch = 18, cex = 2, col = col_cell_draw)
...
# text(ulon_grid_low[3] - dlon_text1, ulat_grid_low[3], 'lat_bnds(i,j,2)', col = col_grid_text, cex = 1.5, pos = 2)
